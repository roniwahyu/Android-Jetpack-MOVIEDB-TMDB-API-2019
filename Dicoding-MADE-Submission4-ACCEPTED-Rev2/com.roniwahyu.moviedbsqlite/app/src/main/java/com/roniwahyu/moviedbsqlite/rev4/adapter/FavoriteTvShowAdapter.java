package com.roniwahyu.moviedbsqlite.rev4.adapter;
...
import com.roniwahyu.moviedbsqlite.rev4.TvShowDetailActivity;
    ...
    public void onBindViewHolder(@NonNull RecycleViewHolder recycleViewHolder, final int i) {
        ...
        recycleViewHolder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra(TvShowDetailActivity.DETAIL_TV_SHOW_EXTRA, getTvshow().get(i));
