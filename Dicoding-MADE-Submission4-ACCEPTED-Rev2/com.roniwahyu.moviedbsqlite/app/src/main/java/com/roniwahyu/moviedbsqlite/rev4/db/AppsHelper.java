...
import static com.roniwahyu.moviedbsqlite.rev4.db.AppsDatabaseContract.*;
...
public class AppsHelper {
    ...
    public ArrayList<Movie> getAllMovies(){
        ...
        if(movieCursor.getCount()>0){
            do{
                ...
                movie.setPoster_path_string(movieCursor.getString(movieCursor.getColumnIndexOrThrow(MovieColumns.POSTER_PATH_STRING)));
                movie.setVote_average(movieCursor.getDouble(movieCursor.getColumnIndexOrThrow(MovieColumns.VOTE_AVERAGE)));
                movie.setOverview(movieCursor.getString(movieCursor.getColumnIndexOrThrow(MovieColumns.OVERVIEW)));
                ...
                movie.setBackdrop_path_string(movieCursor.getString(movieCursor.getColumnIndexOrThrow(MovieColumns.BACKDROP_PATH_STRING)));
    ...
    public long insertMovie(Movie movie) {
        ...
        args.put(MovieColumns.OVERVIEW, movie.getOverview());
        args.put(MovieColumns.RELEASE_DATE, movie.getRelease_date());
        args.put(MovieColumns.VOTE_AVERAGE, movie.getVote_average());
        args.put(MovieColumns.POSTER_PATH_STRING, movie.getPoster_path_string());
        args.put(MovieColumns.BACKDROP_PATH_STRING, movie.getBackdrop_path_string());
    ...
    public ArrayList<TvShow> getAllTvseries(){
        ...
        if (tvshowCursor.getCount() > 0) {
            do {
                ...
                tvshow.setOverview(tvshowCursor.getString(tvshowCursor.getColumnIndexOrThrow(TvShowColumns.OVERVIEW)));
                tvshow.setFirst_air_date(tvshowCursor.getString(tvshowCursor.getColumnIndexOrThrow(TvShowColumns.FIRST_AIR_DATE)));
                tvshow.setVote_average(tvshowCursor.getDouble(tvshowCursor.getColumnIndexOrThrow(TvShowColumns.VOTE_AVERAGE)));
                tvshow.setPoster_path_string(tvshowCursor.getString(tvshowCursor.getColumnIndexOrThrow(TvShowColumns.POSTER_PATH_STRING)));
                tvshow.setBackdrop_path_string(tvshowCursor.getString(tvshowCursor.getColumnIndexOrThrow(TvShowColumns.BACKDROP_PATH_STRING)));
    ...
    public long insertTv(TvShow tvshow) {
        ...
        args.put(TvShowColumns.OVERVIEW, tvshow.getOverview());
        args.put(TvShowColumns.FIRST_AIR_DATE, tvshow.getFirst_air_date());
        args.put(TvShowColumns.VOTE_AVERAGE, tvshow.getVote_average());
        args.put(TvShowColumns.POSTER_PATH_STRING, tvshow.getPoster_path_string());
        args.put(TvShowColumns.BACKDROP_PATH_STRING, tvshow.getBackdrop_path_string());
