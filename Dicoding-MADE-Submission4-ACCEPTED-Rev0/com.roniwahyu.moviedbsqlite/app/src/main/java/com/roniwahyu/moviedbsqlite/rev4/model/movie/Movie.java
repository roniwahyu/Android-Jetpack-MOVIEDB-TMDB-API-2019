package com.roniwahyu.moviedbsqlite.rev4.model.movie;
...
public class Movie implements Parcelable {
    ...
    public Movie (JSONObject object) {
        try {
            ...
            String poster_path = BuildConfig.URL_IMAGE_BASE + object.getString("poster_path");
            String backdrop_path = BuildConfig.URL_IMAGE_BASE + object.getString("backdrop_path");
            this.id = id;
            this.title = title;
            this.overview = overview;
            this.release_date = release_date;
